...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WMSSource.enable_search'
        db.add_column('lizard_wms_wmssource', 'enable_search', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WMSSource.enable_search'
        db.delete_column('lizard_wms_wmssource', 'enable_search')
