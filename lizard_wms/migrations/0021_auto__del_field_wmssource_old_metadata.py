...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WMSSource.old_metadata'
        db.delete_column('lizard_wms_wmssource', 'old_metadata')


    def backwards(self, orm):
        
        # Adding field 'WMSSource.old_metadata'
        db.add_column('lizard_wms_wmssource', 'old_metadata', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
