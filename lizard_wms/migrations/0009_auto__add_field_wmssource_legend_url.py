...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WMSSource.legend_url'
        db.add_column('lizard_wms_wmssource', 'legend_url', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WMSSource.legend_url'
        db.delete_column('lizard_wms_wmssource', 'legend_url')
