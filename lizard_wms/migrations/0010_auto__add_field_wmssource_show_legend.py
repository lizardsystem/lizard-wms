...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WMSSource.show_legend'
        db.add_column('lizard_wms_wmssource', 'show_legend', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WMSSource.show_legend'
        db.delete_column('lizard_wms_wmssource', 'show_legend')
