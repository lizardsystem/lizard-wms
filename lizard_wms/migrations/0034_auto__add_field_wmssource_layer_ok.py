...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WMSSource.layer_ok'
        db.add_column('lizard_wms_wmssource', 'layer_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WMSSource.layer_ok'
        db.delete_column('lizard_wms_wmssource', 'layer_ok')
