...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WMSConnection.params'
        db.alter_column('lizard_wms_wmsconnection', 'params', self.gf('django.db.models.fields.TextField')())

        # Changing field 'WMSConnection.options'
        db.alter_column('lizard_wms_wmsconnection', 'options', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'WMSConnection.params'
        db.alter_column('lizard_wms_wmsconnection', 'params', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'WMSConnection.options'
        db.alter_column('lizard_wms_wmsconnection', 'options', self.gf('django.db.models.fields.TextField')(null=True))
