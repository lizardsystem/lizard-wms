...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WMSSource.bbox'
        db.add_column('lizard_wms_wmssource', 'bbox', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WMSSource.bbox'
        db.delete_column('lizard_wms_wmssource', 'bbox')
