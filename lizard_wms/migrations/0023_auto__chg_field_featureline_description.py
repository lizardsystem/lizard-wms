...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeatureLine.description'
        db.alter_column('lizard_wms_featureline', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'FeatureLine.description'
        db.alter_column('lizard_wms_featureline', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
