...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WMSSource.timepositions'
        db.delete_column('lizard_wms_wmssource', 'timepositions')

        # Adding field 'WMSSource.has_timepositions'
        db.add_column('lizard_wms_wmssource', 'has_timepositions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WMSSource.timepositions'
        db.add_column('lizard_wms_wmssource', 'timepositions',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'WMSSource.has_timepositions'
        db.delete_column('lizard_wms_wmssource', 'has_timepositions')
    ...
    models = {
        ...
        'lizard_wms.wmssource': {
            ...
            'has_timepositions': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.IntegerField', [], {'default': '1000'}),
            'layer_name': ('django.db.models.fields.TextField', [], {}),
            'layer_ok': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
